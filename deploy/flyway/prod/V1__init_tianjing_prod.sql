...
CREATE TABLE calibration_record (
    ...
    pixel_p1_x            INTEGER       NOT NULL DEFAULT 0,
    pixel_p1_y            INTEGER       NOT NULL DEFAULT 0,
    pixel_p2_x            INTEGER       NOT NULL DEFAULT 0,
    pixel_p2_y            INTEGER       NOT NULL DEFAULT 0,
    pixel_distance        DECIMAL(10,4) NOT NULL,
    scale_mm_per_px       DECIMAL(12,6) NOT NULL,
    calibration_image_url VARCHAR(512)  NULL,
    is_active             BOOLEAN       NOT NULL DEFAULT TRUE,
    calibrated_by         VARCHAR(64)   NOT NULL DEFAULT 'SYSTEM',
    remark                VARCHAR(255)  NULL,
    is_deleted      BOOLEAN       NOT NULL DEFAULT FALSE,
    created_at      TIMESTAMPTZ   NOT NULL DEFAULT NOW(),
    updated_at      TIMESTAMPTZ   NOT NULL DEFAULT NOW(),
